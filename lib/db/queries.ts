 ...
 * This module provides functions for interacting with the database, including user management,
 * chat interactions, document creation, and suggestion requests.
 *
 * Filepath: lib/db/queries.ts
 */
...
export async function getUser(email: string): Promise<Array<User>> {
  try {
    ...
    logError('Failed to get user from database', error);
...
export async function saveChat({
  ...
  try {
    ...
    logError('Failed to save chat in database', error);
...
export async function deleteChatById({ id }: { id: string }) {
  try {
    ...
    logError('Failed to delete chat by id from database', error);
    throw new Error('Failed to delete chat by id from database.');
  }
}
...
export async function getChatsByUserId({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get chats by user from database', error);
    throw new Error('Failed to get chats by user from database.');
  }
}
...
export async function getChatById({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get chat by id from database', error);
    throw new Error('Failed to get chat by id from database.');
  }
}
...
export async function saveMessages({ messages }: { messages: Array<Message> }) {
  try {
    ...
    logError('Failed to save messages in database', error);
    throw new Error('Failed to save messages in database.');
  }
}
...
export async function getMessagesByChatId({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get messages by chat id from database', error);
    throw new Error('Failed to get messages by chat id from database.');
  }
}
...
export async function voteMessage({
  ...
  try {
    ...
    logError('Failed to upvote message in database', error);
    throw new Error('Failed to upvote message in database.');
  }
}
...
export async function getVotesByChatId({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get votes by chat id from database', error);
    throw new Error('Failed to get votes by chat id from database.');
  }
}
...
export async function saveDocument({
  ...
  try {
    ...
    logError('Failed to save document in database', error);
...
export async function getDocumentsById({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get document by id from database', error);
    throw new Error('Failed to get document by id from database.');
  }
}
...
export async function saveSuggestions({
  ...
  try {
    ...
    logError('Failed to save suggestions in database', error);
    throw new Error('Failed to save suggestions in database.');
  }
}
...
export async function getSuggestionsByDocumentId({
  ...
  try {
    ...
    throw new Error('Failed to get suggestions by document version from database.');
  }
}
...
export async function getMessageById({ id }: { id: string }) {
  try {
    ...
    logError('Failed to get message by id from database', error);
    throw new Error('Failed to get message by id from database.');
  }
}
...
export async function updateChatVisiblityById({
  ...
  try {
    ...
    logError('Failed to update chat visibility in database', error);
    throw new Error('Failed to update chat visibility in database.');
  }
}